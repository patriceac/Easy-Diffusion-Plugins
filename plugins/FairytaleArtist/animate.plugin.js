(function() {
    ...
    document.getElementById('editor-inputs-init-image').insertAdjacentHTML('beforeend', `
        <label for="video-file-selector" class="${ID_PREFIX}-video-label">Extract Images from Video</label>
        <button id="${ID_PREFIX}-upload-video-btn" type="button" class="${ID_PREFIX}-btn-primary"><i class="fa fa-photo-film"></i> Select a video<input type="file" id="video-file-selector" accept="video/mp4,video/webm,video/ogg" class="${ID_PREFIX}-file-input"></button>
        ...
        <div id="${ID_PREFIX}-output-format" class="${ID_PREFIX}-output-format">
            <div class="${ID_PREFIX}-time-inputs">
